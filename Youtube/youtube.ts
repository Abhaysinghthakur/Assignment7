...
let setOnFire = new MusicTypeVideo(1,"URl","Set on fire",100,10,5,1,1,"Music","Set on fire By:sia"
                ,"sia","this is acting","sia","some production",[1,2,3,4,5]);


let gamingVideo = new GamingTypeVideo(2,"URl","Game",100,10,5,6,9,"Gaming","PUBG","game",[6,7,8,9,10]);
